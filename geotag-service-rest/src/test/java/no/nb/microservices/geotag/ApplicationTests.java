...
public class ApplicationTests {
    ...
    public void integrationTest1() throws Exception {
        ...
        GeoTag tag1 = new GeoTag("", "a62eb09d-dbf2-495a-8872-7d16e6911296", "URN:NBN:no-nb_foto_NF.W_50121",
                "32e68b89a170214633119b1717b45d56",9.052734375, 66.04758417711061, new Date(),
                "Wilse, Anders Bee");

        GeoTag tag2 = new GeoTag("", "a62eb09d-dbf2-495a-8872-7d16e6911296", "URN:NBN:no-nb_digifoto_20140228_00094_NB_WF_EDK_129136",
        ...
        GeoTag geotag1 = new GeoTag("", USER_ID, "URN:NBN:no-nb_digifoto_20131218_00056_NB_WF_LUR_041262",
                "2b1fffd40bac149f7f0fa52337b9427a", 12.835818529129028, 66.40039201638066, new Date(),
                "Widerøe Flyveselskaps flyfoto fra Lurøy kommune : Rødøy, Lurøy.");
    ...
    public void integrationTest2() throws Exception {
        ...
        GeoTag tag3 = new GeoTag("", "", "URN:NBN:no-nb_digifoto_20131218_00056_NB_WF_LUR_041262",
                "2b1fffd40bac149f7f0fa52337b9427a", 12.835818529129028, 66.40039201638066, new Date(),
                "Widerøe Flyveselskaps flyfoto fra Lurøy kommune : Rødøy, Lurøy.");
        mockMvc.perform(put("/geotags/{tagid}", tag1.getGeoId())
                .contentType(MediaType.APPLICATION_JSON)
